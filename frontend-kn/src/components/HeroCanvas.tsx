  ...
  return (
    <section className="relative min-h-screen bg-black overflow-hidden pt-28 flex items-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 w-[700px] h-[700px] bg-[#D4AF37]/10 blur-[64px] rounded-full -translate-x-1/2 -translate-y-1/2 transform-gpu pointer-events-none" />
        <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))] opacity-20 pointer-events-none" />
        <div className="absolute top-20 right-10 w-[250px] h-[250px] bg-[#D4AF37]/10 blur-[64px] rounded-full transform-gpu pointer-events-none" />
        <div className="absolute bottom-20 left-10 w-[300px] h-[300px] bg-[#D4AF37]/5 blur-[64px] rounded-full transform-gpu pointer-events-none" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              ...
              <Link href="/build-store" className="bg-[#D4AF37] text-black px-8 py-4 rounded-full font-bold hover:scale-105 transition flex items-center justify-center">
                Start Your Project
              </Link>
