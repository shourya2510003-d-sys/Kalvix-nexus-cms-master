              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2.5 mb-8 border-b border-gold-primary/10 pb-6">
                      <span className="font-orbitron font-black text-2xl sm:text-3xl text-gold-primary">
                        {tier.price}
                      </span>
                      {tier.period && (
                        <span className="text-[10px] font-rajdhani font-bold tracking-widest uppercase text-text-muted bg-white/5 border border-gold-primary/10 px-2 py-1 rounded-md shadow-inner">
                          {tier.period}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="mt-8">
                    <a
                      href={`https://wa.me/917906355122?text=${encodeURIComponent("Hello Kalvix Nexus Team! 👋\n\nI am highly interested in subscribing to your *" + (tier.name || 'Service') + "* plan.\n\n📊 *Plan Details:*\n• *Plan Name:* " + (tier.name || 'N/A') + "\n• *Investment:* " + (tier.price || 'N/A') + (tier.period ? " (" + tier.period + ")" : "") + "\n\nCould you please share the next steps with me? Looking forward to connecting! 🚀")}`}
                      target="_blank"
