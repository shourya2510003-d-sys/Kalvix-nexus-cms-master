...
const DIR_PATH = '/Users/apple/Downloads/Shourya DCI DATA/CATEGORY/face & body wash 2';
...
async function main() {
  ...
  files.forEach(file => {
    ...
    // Match SKU pattern e.g., DCIFB01, DCIFB02, etc.
    const match = file.match(/DCIFB\d+/i);
    if (match) {
