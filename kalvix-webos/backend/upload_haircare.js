...
const DIR_PATH = '/Users/apple/Downloads/Shourya DCI DATA/CATEGORY WITH INGREDIENTS/haircare';
...
async function main() {
  ...
  files.forEach(file => {
    ...
    // Match SKU pattern e.g., DCIH01, DCIH02, etc.
    const match = file.match(/DCIH\d+/i);
    if (match) {
