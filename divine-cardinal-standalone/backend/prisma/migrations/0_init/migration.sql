...
-- CreateEnum
CREATE TYPE "TenantRole" AS ENUM ('OWNER', 'EDITOR', 'DESIGNER', 'MARKETING');

-- CreateEnum
CREATE TYPE "PublishedStatus" AS ENUM ('DRAFT', 'PUBLISHED', 'ARCHIVED');
...
CREATE TABLE "CmsLayout" (
    ...
    CONSTRAINT "CmsLayout_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CmsPage" (
    ...
    "description" TEXT,
    "seoMetadata" JSONB,
    "status" "PublishedStatus" NOT NULL DEFAULT 'DRAFT',
...
-- CreateIndex
CREATE UNIQUE INDEX "CmsLayout_pageId_key" ON "CmsLayout"("pageId");
...
-- CreateIndex
CREATE UNIQUE INDEX "DesignToken_tenantId_key_key" ON "DesignToken"("tenantId", "key");
...
-- AddForeignKey
ALTER TABLE "CmsSection" ADD CONSTRAINT "CmsSection_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CmsComponent" ADD CONSTRAINT "CmsComponent_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CmsComponent" ADD CONSTRAINT "CmsComponent_sectionId_fkey" FOREIGN KEY ("sectionId") REFERENCES "CmsSection"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GlobalComponent" ADD CONSTRAINT "GlobalComponent_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DesignToken" ADD CONSTRAINT "DesignToken_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
