...
import { Target, Eye, ShieldCheck, Heart, Sparkles, TrendingUp, Cpu, Award } from 'lucide-react';
...
const TIMELINE = [
  { year: '2023', title: 'Agency Foundation', desc: 'Established in Hathras, UP as a high-end software development studio working with early-stage startups.' },
  { year: '2024', title: 'Integrated Growth Pivot', desc: 'Introduced Meta & Google Ads performance marketing divisions, bridging the gap between tech and customer acquisition.' },
  { year: '2025', title: 'Scale & Milestones', desc: 'Successfully managed 50L+ in client ad spend, achieving an average of 350% client growth across sectors.' },
  { year: '2026', title: 'The Nexus Era', desc: 'Consolidating AI automation assets with high-end digital marketing campaigns to build automated sales engines.' },
];
  ...
  return (
    <div className="bg-bg-primary text-text-primary min-h-screen pb-24 relative overflow-hidden">
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto z-10 relative">
        ...
        <div className="relative border-l border-gold-primary/10 pl-6 ml-4 space-y-12">
          {TIMELINE.map((time, idx) => (
            <motion.div key={idx} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: idx * 0.1 }} className="relative">
